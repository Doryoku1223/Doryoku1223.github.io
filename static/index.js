...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 30) return '我测你码';
    if (score <= 60) return '瑞克电子烟';
    if (score <= 100) return '雪豹闭嘴';
    if (score <= 150) return '我测你们码';
    return '你就是顶针本人？';
}
